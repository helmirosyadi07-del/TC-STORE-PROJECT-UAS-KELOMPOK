...
<div class="heroe">
    ...
    <form action="[NAMA_CONTROLLER]/submit_data" method="POST">
...
<style>
/* **PROPERTI KUNCI UNTUK MENENGGAHKAN FORM** */
.heroe {
    max-width: 450px; /* Tentukan lebar maksimal */
    margin-left: auto; /* Rata tengah kiri */
    margin-right: auto; /* Rata tengah kanan */
    text-align: center; /* Menengahkan konten seperti judul h1 */
}

.heroe form {
    display: inline-block; /* Agar form itu sendiri bisa di tengah */
    text-align: left; /* Mengembalikan teks di dalam form ke rata kiri */
}

/* Style untuk Input dan Label agar Rapi */
.heroe label {
    display: inline-block;
    width: 80px; 
    text-align: right; /* Label rata kanan agar rapi */
    margin-right: 10px; 
}

.heroe input[type="text"], 
.heroe input[type="email"] {
    width: 200px;
    padding: 5px;
    margin-bottom: 5px; /* Margin bawah yang standar */
}
</style>
